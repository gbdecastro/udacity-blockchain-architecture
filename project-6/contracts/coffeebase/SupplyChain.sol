...
// Define a modifier that checks if an item.state of a upc is Harvested
  ...
  function processItem(uint _upc) public harvested(_upc) onlyFarmer verifyCaller(items[_upc].originFarmerID) {
  ...
  function sellItem(uint _upc, uint _price) public packed(_upc) onlyFarmer verifyCaller(items[_upc].originFarmerID) {
    // Update the item state and price
  ...
  function buyItem(uint _upc) public payable forSale(_upc) onlyDistributor paidEnough(items[_upc].productPrice) checkValue(_upc) {
    // Update the item state and owner
  ...
  function shipItem(uint _upc) public sold(_upc) onlyDistributor verifyCaller(items[_upc].originFarmerID) {
    // Update the item state
  ...
  function receiveItem(uint _upc) public shipped(_upc) onlyRetailer verifyCaller(items[_upc].distributorID) {
    // Update the item state and owner
